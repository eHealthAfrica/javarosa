...
public class DynamicXForm6_500_10X500_Benchmark {

    public static void main(String[] args) {
        dryRun(DynamicXForm6_500_10X500_Benchmark.class);
    }
    ...
    public static class FormTypesState {
        ...
        public void initialize() throws IOException {
            ...
            String title = "DynamicXForm6_500_10X500";
            final int noOfQuestions = 500;
            final int noOfInternalSecondaryInstances = 10;
            final int noOf2ndryInstanceElements = 500;
