...
public class DynamicXForm7_500_1X50000_Benchmark {

    public static void main(String[] args) {
        dryRun(DynamicXForm7_500_1X50000_Benchmark.class);
    }
    ...
    public static class FormTypesState {
        ...
        public void initialize() throws IOException {
            ...
            String title = "DynamicXForm7_500_1X50000";
            final int noOfQuestions = 500;
            final int noOfInternalSecondaryInstances = 1;
            final int noOf2ndryInstanceElements = 50000;
