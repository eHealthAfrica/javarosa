...
public class InternalDataInstanceBuildBenchmark {
    ...
    public static class InternalDataInstanceState {
        ...
        public void initialize() throws IOException {
            xFormXmlFile = generateXFormFile(noOfQuestions, noOfQuestionGroups, noOfInternalSecondaryInstances, noOfExternalSecondaryInstances, noOf2ndryInstanceElements).toPath();
        }
    }
    ...
    public void runBenchmark(InternalDataInstanceState state, Blackhole bh)
        ...
        InternalDataInstance internalInstance =
            InternalDataInstanceParser.build("internal_secondary_instance_"+state.noOf2ndryInstanceElements+"E_01",state.xFormXmlFile);
